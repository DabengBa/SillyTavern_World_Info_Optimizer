...
本脚本在社区网友分享版本的基础上，进行了大量的交互优化与功能增强，旨在解决用户在管理大量条目时的核心痛点，让您的使用体验更加流畅自然。现在已升级至 v3.2 版本，采用模块化架构（src 目录），提升了代码的可维护性和稳定性，同时保持了所有原有功能。
...
### 新增功能
- 🆕 **世界书条目状态体系**：为每个条目提供“永久激活 / 关键词触发 / 向量化”三种状态标签，标题行会展示彩色徽章，编辑器中可直接切换。
- 🆕 **统一状态批量操作**：多选条目后，可通过工具栏的“统一状态”菜单一键批量改写激活方式，自动过滤未保存或重复项。
- 🆕 **孤立世界书筛选**：全局世界书列表新增“选择孤立世界书”按钮，一键高亮未绑定任意角色卡的世界书，用于清理或批量维护。

### Debug & 修复
- 🔧 **统一位置体验优化**：在多选模式下仅作用于已勾选条目，并增加二次确认提示，避免误操作整本世界书。
- 🔧 **角色世界书空白修复**：角色标签默认回落到首个可用世界书，防止初次打开或切换角色后面板空白。
- 🔧 **替换确认细节**：替换摘要展示具体作用范围与命中统计，便于审核批量修改影响。
- 🔧 **条目状态兼容性**：新建条目自动附带默认状态与策略结构，确保与 SillyTavern 后端字段保持一致。

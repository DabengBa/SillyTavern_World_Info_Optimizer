    ...
    function main($, TavernHelper) {
        ...
        const loadAllData = errorCatched(async () => {
            ...
            if (charLinkedBooks?.primary) {
                ...
                knownBookNames.add(charLinkedBooks.primary);
            }
            if (charLinkedBooks?.additional) {
                charLinkedBooks.additional.forEach(name => {
                    charBookSet.add(name);
                    knownBookNames.add(name);
                });
            }
        ...
        const renderCharacterLorebookView = (searchTerm, $container) => {
            ...
            const renderBook = (bookName) => {
                ...
                const $entryActions = $(`<div class="rlh-entry-actions"><button class="rlh-action-btn rlh-create-entry-btn" data-book-name="${escapeHtml(bookName)}"><i class="fa-solid fa-plus"></i> 新建条目</button></div>`);
        ...
        const createGlobalLorebookElement = (book, searchTerm, forceShowAllEntries, filteredEntries) => {
            const $element = $(`<div class="rlh-book-group" data-book-name="${escapeHtml(book.name)}"><div class="rlh-global-book-header"><span class="rlh-item-name">${escapeHtml(book.name)}</span><div class="rlh-item-controls"><button class="rlh-toggle-btn rlh-global-toggle" title="启用/禁用整个世界书"><i class="fa-solid fa-power-off"></i></button><button class="rlh-action-btn-icon rlh-delete-book-btn" title="删除世界书"><i class="fa-solid fa-trash-can"></i></button></div></div><div class="rlh-collapsible-content"></div></div>`);
            ...
            const $entryActions = $(`<div class="rlh-entry-actions"><button class="rlh-action-btn rlh-create-entry-btn" data-book-name="${escapeHtml(book.name)}"><i class="fa-solid fa-plus"></i> 新建条目</button></div>`);
        ...
        function initializeScript() {
            ...
            const styles = `<style id="regex-lore-hub-styles">
                ...
                #${PANEL_ID} { 
                    ...
                    width: 90%; max-width: 650px; height: 80vh; max-height: 80vh; 
                ...
                #${SEARCH_INPUT_ID} { 
                    ...
                    border-radius: 8px; box-sizing: border-box; background-color: var(--rlh-input-bg); color: var(--rlh-text-color);
                } 
                ...
                .rlh-multi-select-mode .rlh-toggle-btn { display: none;} 
                ...
                .rlh-action-btn.rlh-create-entry-btn { background-color: var(--rlh-green-bg); color: var(--rlh-green); border: 1px solid var(--rlh-green); width: 100%;} 
            ...
            const panelHtml = `<div id="${PANEL_ID}">
                ...
                <div class="rlh-search-container">
                    ...
                    <div id="rlh-search-filters-container">
